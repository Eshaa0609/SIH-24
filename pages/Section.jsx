            ...
            <div id="carouselExampleCaptions" className="carousel-slide" data-bs-ride="carousel" data-bs-interval="5000">
                ...
                <div className="carousel-inner">
                    <div className="carousel-item active">
                        <img src="/imgs/india4.jpg" className="d-block w-100" alt="First slide"/>
                    ...
                    <div className="carousel-item">
                        <img src="/imgs/india2.jpg" className="d-block w-100" alt="Second slide"/>
                        <div className="carousel-caption d-none d-md-block">
                    ...
                    <div className="carousel-item">
                        <img src="/imgs/india3.jpg" className="d-block w-100" alt="Third slide"/>
                        <div className="carousel-caption d-none d-md-block">
                    ...
                    <div className="carousel-item">
                        <img src="/imgs/india1.png" className="d-block w-100" alt="Fourth slide"/>
                        <div className="carousel-caption d-none d-md-block">
